...
type IRequest interface {
	...
	AddCookie(k string, v interface{}) *Request
...
// map | string(query | lines | json)
func (rq *Request) SetCookie(v interface{}) *Request {
	return rq
}

func (rq *Request) AddCookie(k string, v interface{}) *Request {
	rq.p.Cookie[k] = anyToString(v)
	return rq
}
